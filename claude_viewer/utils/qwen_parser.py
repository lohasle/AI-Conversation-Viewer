...
class QwenParser:
    def __init__(self, qwen_projects_path: str = None):
        self.qwen_projects_path = qwen_projects_path or os.path.expanduser(
            "~/.qwen/tmp"
        )
                    ...
                    if os.path.exists(qwen_md_path):
                        with open(qwen_md_path, "r", encoding="utf-8") as f:
                            ...
                            if first_line.startswith("# "):
                                ...
                                project_name = (
                                    first_line if first_line else project_hash
                                )
    ...
    def get_conversation(
        ...
        session_path = os.path.join(
            self.qwen_projects_path, project_name, "chats", f"{session_id}.json"
        )
